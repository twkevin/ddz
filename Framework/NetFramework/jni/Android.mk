...
LOCAL_SRC_FILES := $(LIBS_PATH)/ForAndroid/libiconv.a
...
EXCLUDE_SRC_FILES := %.svn %prop-base %props %text-base %tmp %.proto %thread_win32.cpp %UserConfig.cpp
...
LOCAL_MODULE:=netframework_static
